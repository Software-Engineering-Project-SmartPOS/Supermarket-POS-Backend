...
public class StockLevelController {
    ...
    @Secured({"ROLE_ADMIN", "ROLE_MANAGER", "ROLE_OWNER","ROLE_CASHIER","ROLE_CUSTOMER","ROLE_STORE_MANAGER","ROLE_SALES_ASSISTANT"})
    @QueryMapping
    public List<StockLevel> AllStockLevelsByStatus(@Argument StockLevelStatus status, Principal principal) {
        return stockLevelService.getAllStockLevelsByStatus(status,principal);
    }
